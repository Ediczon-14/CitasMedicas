...
public class ServletAdmin extends HttpServlet {
    ...
    Modelo.ModeloAdmin m  = new ModeloAdmin();
    public ServletAdmin() 
    {
        super();
            ...
            throws ServletException, IOException 
    {
        ...
        Admin e = m.iniciarSesion(usuario, clave);
        if(e==null)
        {   
        ...
        {
            request.setAttribute("admin", e);
            request.getRequestDispatcher("displayAdmin.jsp").forward(request,response);
