<%-- 
    Document   : registrarCitas
    Created on : 24-may-2021, 10:58:17
    Author     : edicz
--%>
                    ...
                    <form action="ServletCita" name="formulario1">
                        ...
                        <table>
                            <tr>
                                ...
                                <tr>
                                    <td>idPaciente</td>
                                    <td><input type="text" name="idPaciente" required class="form-control" value="<jsp:getProperty name="pacienteBean1" property ="codPac" />"></td>
                                </tr>
                                <tr>
                                    <td></td>
